...
video_opts = {
    ...
    "cookiefile": "BlBl/cozc.txt",  # إضافة ملف الكوكيز هنا
    "postprocessors": [
...
async def _(event): #Code by T.me/zzzzl1l
    ...
    'cookiefile': 'BlBl/cozc.txt',  # تحديد ملف الكوكيز
    }
    try:
...
ZelzalMeMe_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ - اوامـر البصمـات 🎙](t.me/QU_QUU) 𓆪\n\n"
