...
COOKIE_FILE = "BlBl/cozc.txt"  # ملف الكوكيز
plugin_category = "البوت"

# تعديل دوال التحميل لاستخدام الكوكيز
async def _mp3Dl(url, starttime, uid):
    import yt_dlp
    file_name = f"{uid}.mp3"
    ydl_opts = {
        ...
        "cookiefile": COOKIE_FILE,  # استخدام الكوكيز
        "quiet": True
    }
    try:
...
async def _tubeDl(url, starttime, uid):
    import yt_dlp
    file_name = f"{uid}.mp4"
    ydl_opts = {
